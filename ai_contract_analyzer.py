...
- Если субъекты — ФИЗИЧЕСКИЕ ЛИЦА (физлица), то правильный суд — СУД ОБЩЕЙ ЮРИСДИКЦИИ (ГПК РФ)
- Если субъекты — ЮРИДИЧЕСКИЕ ЛИЦА (юрлица), то правильный суд — АРБИТРАЖНЫЙ СУД (АПК РФ)
- Если указан НЕПРАВИЛЬНЫЙ суд для данного субъектного состава — ставь ⚠️ и укажи ошибку

ВАЖНО ДЛЯ ВСЕХ ПУНКТОВ:
- Комментарий — МИНИМУМ 10 СЛОВ с конкретикой
- Для недвижимости указывай: адрес, площадь, кадастровый номер
- НЕ используй markdown
- НЕ пропускай пункты

ФОРМАТ (РОВНО 10 строк + ИТОГО):
✅ 1. Предмет договора: [комментарий 10+ слов]
✅ 2. Цена и порядок расчётов: [комментарий 10+ слов]
✅ 3. Сроки исполнения: [комментарий 10+ слов]
✅ 4. Ответственность: [комментарий 10+ слов]
✅ 5. Форс-мажор: [комментарий 10+ слов]
✅ 6. Подсудность: [комментарий 10+ слов с проверкой правильности суда]
✅ 7. Расторжение: [комментарий 10+ слов]
✅ 8. Персональные данные: [комментарий 10+ слов]
✅ 9. Существенные условия: [комментарий 10+ слов]
✅ 10. Односторонние изменения: [комментарий 10+ слов]
