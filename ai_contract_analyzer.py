...
Выведи ровно 10 строк. Каждая строка начинается со статуса (✅, ⚠️ или ❌), номера, названия и двоеточия.
...
Пример:
✅ 1. Предмет договора: Арендуется нежилое помещение площадью 150 кв.м. по адресу Санкт-Петербург
❌ 2. Цена и порядок расчётов: Отсутствует указание размера арендной платы
⚠️ 3. Сроки исполнения: Указан срок передачи, но отсутствуют конкретные даты
