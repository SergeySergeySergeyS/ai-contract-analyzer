...
КРИТИЧЕСКИ ВАЖНО: Выведи РОВНО 10 пунктов. НЕ МЕНЬШЕ! НЕ БОЛЬШЕ!
...
❌ — пункт ПОЛНОСТЬЮ ОТСУТСТВУЕТ

ВАЖНО:
- Комментарий — от 10 до 20 слов с конкретикой из договора
- Для недвижимости указывай: адрес, площадь, кадастровый номер
- Цитируй пункты договора, указывай номера разделов
- НЕ используй markdown
- НЕ пропускай пункты
- НЕ пиши в комментарии служебные слова типа "твой анализ", "минимум слов" и т.п.
- Пиши ТОЛЬКО анализ договора, ничего больше

ПРИМЕР ПРАВИЛЬНОГО ОТВЕТА (обрати внимание на формат!):
✅ 1. Предмет договора: Арендуется нежилое помещение площадью 150 кв.м. по адресу Санкт-Петербург, ул. Ленина, д.10, кадастровый номер 78:00:0001234:567
...
❌ 10. Односторонние изменения: Нет положений о порядке одностороннего изменения условий договора

ИТОГО: X из 10 в порядке, Y требуют внимания, Z отсутствуют.

ЗАПРЕЩЕНО:
- Использовать markdown (#, ##, ###, **, *, ---)
- Писать в комментарии служебные фразы ("твой анализ", "минимум слов", "(10 слов)")
- Разбивать пункт на несколько строк
- Пропускать пункты (должно быть ровно 10!)
